  ...
  return (
    <div style={{ padding: '24px 28px', maxWidth: 1400, margin: '0 auto', color: 'var(--text-primary)' }}>
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ margin: '8px 0 0', color: 'var(--text-secondary)', fontSize: '0.95rem' }}>
            Nền tảng bản lề 50 bài Minna vững chắc • Bẻ khóa bẫy đề thi Shinkanzen N3–N1 • Tuyển tập đề thi thật 10 năm (2014–2024).
          </p>
        </div>

        {/* Global Statistics */}
        <div style={{ display: 'flex', gap: 14 }}>
          <div style={{ background: 'var(--bg-elevated)', padding: '10px 16px', borderRadius: 10, textAlign: 'center', border: '1px solid var(--glass-border)' }}>
            <div style={{ fontSize: '1.25rem', fontWeight: 800, color: '#38bdf8' }}>50</div>
            <div style={{ fontSize: '0.75rem', color: 'var(--text-tertiary)' }}>Bài Minna (N5-N4)</div>
          </div>
          <div style={{ background: 'var(--bg-elevated)', padding: '10px 16px', borderRadius: 10, textAlign: 'center', border: '1px solid var(--glass-border)' }}>
            <div style={{ fontSize: '1.25rem', fontWeight: 800, color: '#f59e0b' }}>460+</div>
            <div style={{ fontSize: '0.75rem', color: 'var(--text-tertiary)' }}>Mẫu Bẫy N3-N1</div>
          </div>
          <div style={{ background: 'var(--bg-elevated)', padding: '10px 16px', borderRadius: 10, textAlign: 'center', border: '1px solid var(--glass-border)' }}>
            <div style={{ fontSize: '1.25rem', fontWeight: 800, color: '#10b981' }}>63</div>
            <div style={{ fontSize: '0.75rem', color: 'var(--text-tertiary)' }}>Đề Thi 10 Năm</div>
          </div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <button
          onClick={() => { setMainTab('n3'); setSelectedChapterIdx(0); setSelectedPointId(null); }}
          style={{
            padding: '10px 20px',
            borderRadius: 10,
            border: 'none',
        ...
        >
          🥋 Lò Luyện N3 Shinkanzen Master
        </button>

        <button
          onClick={() => { setMainTab('n2'); setSelectedChapterIdx(0); setSelectedPointId(null); }}
          style={{
            padding: '10px 20px',
            borderRadius: 10,
            border: 'none',
        ...
        >
          ⚔️ Lò Luyện N2 Shinkanzen Master
        </button>

        <button
          onClick={() => { setMainTab('n1'); setSelectedChapterIdx(0); setSelectedPointId(null); }}
          style={{
            padding: '10px 20px',
            borderRadius: 10,
            border: 'none',
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '360px 1fr', gap: 24, alignItems: 'start' }}>
          ...
          <div style={{ background: 'var(--bg-surface)', border: '1px solid var(--glass-border)', borderRadius: 14, padding: 28 }}>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 10, fontWeight: 700, color: '#38bdf8' }}>
                <Compass size={18} /> SƠ ĐỒ TƯ DUY BẢN LỀ (TREE MINDMAP): {activeLesson.mindmap.center}
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6, marginBottom: 10, fontSize: '0.9rem' }}>
                {activeLesson.mindmap.branches.map((branch, bIdx) => (
                  <div key={bIdx} style={{ display: 'flex', alignItems: 'center', gap: 8, color: 'var(--text-secondary)' }}>
                    <span style={{ color: '#38bdf8' }}>•</span> {branch}
                  </div>
                ))}
              </div>
              <div style={{ fontSize: '0.85rem', color: '#f59e0b', background: 'rgba(245, 158, 11, 0.1)', padding: '6px 12px', borderRadius: 6 }}>
